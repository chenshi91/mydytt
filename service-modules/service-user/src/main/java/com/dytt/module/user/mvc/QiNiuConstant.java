...
public class QiNiuConstant {
     ...
     * 七牛云视频封面地址后缀
     */
    public final static String VIDEO_COVER_SUFFIX = "?vframe/jpg/offset/1/w/750";

    /**
     * 七牛云视频封面地址后缀,较小图
     */
    public final static String VIDEO_COVER_SMALL_IMAGE = "?vframe/jpg/offset/1/w/250";

    /**
     * 七牛云视频封面地址后缀,中等图
     */
    public final static String VIDEO_COVER_MEDIUM_IMAGE = "?vframe/jpg/offset/1/w/500";
     ...
     * 图片尺寸调整
     */
    public final static String PIC_BEAUTIFUL_THUMBNAIL = "?imageView2/2/w/800";
