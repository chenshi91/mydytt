...
//        ArrayList<com.dytt.test.api.Demo> arrayList = Lists.newArrayList();
//        Map<Long, List<com.dytt.test.api.Demo>> listMap = arrayList.stream().collect(Collectors.groupingBy(com.dytt.test.api.Demo::getId));
