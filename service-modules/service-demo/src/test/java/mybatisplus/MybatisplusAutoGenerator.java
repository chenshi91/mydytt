    ...
    public void system() {
        AutoGenerator mpg = new AutoGenerator() {{
            ...
            setGlobalConfig(new GlobalConfig() {{
                setOutputDir("D:\\javaProjects\\mydytt\\api-modules\\api-test\\src\\main\\java");
            ...
            setStrategy(new StrategyConfig() {{
                ...
                setSuperEntityClass("com.dytt.common.api.BaseEntity");
                setSuperMapperClass("com.dytt.common.api.BaseMapper");
                setSuperServiceImplClass("com.dytt.common.api.BaseServiceImpl");
                setSuperServiceClass("com.dytt.common.api.BaseService");
                setSuperControllerClass("com.dytt.common.api.BaseController");
